			...
			<div class="navigation" id="sticker"><!-- navigation menu --> 
                ...
                <ul class="slide_down menu-bars panel1-menu" style = "background-color: #000;display: block !important; ">
                    ...
                    <?php
                            ...
                            <li><a href="what-consign2">EVENT INFO</a></li>

                            <li><a href="#start-reducing2">HOW TO CONSIGN</a></li>

                            <li><a href="consign2">WHY CONSIGN?</a></li>

                            <li><a href="profit2">POTENTIAL PROFIT</a></li>

                            <li><a href="accept2">WHAT WE ACCEPT</a></li>
